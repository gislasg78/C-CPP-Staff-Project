...
int main()
	{
		...
		int my_array[] = {12, 7, 11, 10, 13, 3, 3, 20, 1, 16, 9, 4, 14};	//Raw arrangement of integer values.
		...
		/* Testing values ​​on unsorted numerical sets with a single value. */
		std::unordered_set<int> us(std::begin(my_array), std::end(my_array));

		std::cout << "A set of unordered but unique numerical values." << std::endl;
		...
		/* Testing values ​​on unsorted numerical sets with a non-unique value. */
		std::unordered_multiset<int> ums(std::begin(my_array), std::end(my_array));

		std::cout << "A set of unordered but non-unique numerical values." << std::endl;
		...
		std::cout << "A set of unordered but unique object instances." << std::endl;
		...
		std::cout << "A set of unordered but non-unique object instances." << std::endl;
