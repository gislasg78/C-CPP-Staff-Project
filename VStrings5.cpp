...
class Auto_ptr
{
	...
	public:
		...
		Auto_ptr(Auto_ptr&& auto_ptr) : ptr(auto_ptr.ptr)
		{
...
int main()
{
	std::cout << "Deep Copy & Move constructors and Deep Copy & Move Assignment operators." << std::endl;
