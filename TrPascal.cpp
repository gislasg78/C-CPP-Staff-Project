...
void Pascal_s_Triangle::clear_Pascal_s_Triangle()
	{
		cout << "Initializing Pascal's Triangle. Object # [" << sttc_int_Counting_Pascal_s_Triangles << "]." << endl;

		if (this->ptr_int_Pascal_s_Triangle != NULL && this->int_number_Rows > V_ZERO)
			{
			...
			cout << "Warning! Pascal's Triangle was already initialized." << endl;
	};
		...
		if (int_n_Levels >= LIM_MIN && int_n_Levels <= LIM_MAX)
			{
				...
				psTOld.get_int_number_Rows();
				psTOld.create_new_Pascal_s_Triangle();
				psTOld.view_Pascal_s_Triangle();
				psTOld.clear_Pascal_s_Triangle();
				psTOld.get_int_number_Rows();
				psTOld.set_int_number_Rows(int_n_Levels);
				psTOld.view_Pascal_s_Triangle();
				psTOld.create_new_Pascal_s_Triangle();
				psTOld.view_Pascal_s_Triangle();
