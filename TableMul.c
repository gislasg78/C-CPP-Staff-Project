...
int main()
	{
		...
		printf("+---|----+---|----+---|----+---|---+----|---+\n");
		printf("Columns from [%d] to [%d]: ", V_LIM_MIN, V_LIM_MAX);
		scanf("%d", &int_X);
		printf("Rows    from [%d] to [%d]: ", V_LIM_MIN, V_LIM_MAX);
		scanf("%i", &int_Y);
		 ...
		 * -------------------------------------------- */
		if (int_Y >= V_LIM_MIN && int_Y <= V_LIM_MAX)
			if (int_X >= V_LIM_MIN && int_X <= V_LIM_MAX)
				{
